...
### Contact
Email: xinhong.chen@cityu.edu.hk

Address: Department of Computer Science, City University of Hong Kong

### Selected Publication
- **Xinhong Chen**, Qing Li, Zongxi Li, Haoran Xie, Fu Lee Wang, Jianping Wang. [A Reinforcement Learning Based Two-Stage Model for Emotion Cause Pair Extraction](https://ieeexplore.ieee.org/abstract/document/9933859). In: IEEE Transactions on Affective Computing, 2022, doi: 10.1109/TAFFC.2022.3218648.
...
- Yifan Zhang, **Xinhong Chen**, Jianping Wang, Zuduo Zheng, Kui Wu. [A Generative Car-following Model Conditioned On Driving Styles](https://www.sciencedirect.com/science/article/pii/S0968090X22003394). In: 	Transportation Research Part C: Emerging Technologies, vol. 15, 103926, 2022.
